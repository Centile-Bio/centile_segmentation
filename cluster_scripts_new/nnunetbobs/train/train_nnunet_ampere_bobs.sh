...
if [ -z "$1" ]; then
    ...
    echo "Usage: sbatch run_nnunetv2.sh <DATASET_ID>"
    exit 1
fi
...
DATASET_OUTPUT_PATH="/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/nnunet/nnUNet_results/Dataset0${DATASET_ID}_bobs"
