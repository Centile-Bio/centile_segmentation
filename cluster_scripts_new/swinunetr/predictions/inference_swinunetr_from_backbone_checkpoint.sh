...
#SBATCH --output=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/logs/inference_swinunetr_from_backbone_checkpoint%j.out
#SBATCH --error=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/errors/inference_swinunetr_from_backbone_checkpoint%j.err
...
/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/conda_envs/swinunetr/bin/python /home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/research-contributions/SwinUNETR/BRATS21/predict.py \
    ...
    --noamp \
    --use_checkpoint \
    --pretrained_dir /home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/research-contributions/SwinUNETR/BRATS21/runs/tr_from_backbone_checkpoint \
