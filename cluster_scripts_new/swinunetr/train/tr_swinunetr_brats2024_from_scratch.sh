#!/bin/bash
#SBATCH -J tr_swinunetr_brats2024_from_scratch
...
#SBATCH --output=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/logs/tr_swinunetr_brats2024_from_scratch%j.out
#SBATCH --error=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/errors/tr_swinunetr_brats2024_from_scratch%j.err
