...
#SBATCH --output=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/logs/tr_bobs_nnunetv2%j.out
#SBATCH --error=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/errors/tr_bobs_nnunetv2%j.err

# Print the start of the job script
echo "=== Starting job script ==="

# **Define dataset ID at the top**
DATASET_ID=21     
# Print the dataset ID
echo "Dataset ID: $DATASET_ID"

# Generate dataset path strings
DATASET_INPUT_PATH="/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/nnunet/nnUNet_raw/Dataset0${DATASET_ID}_bobs24/imagesTs"    
DATASET_OUTPUT_PATH="/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/nnunet/nnUNet_results/Dataset0${DATASET_ID}_bobs24"
