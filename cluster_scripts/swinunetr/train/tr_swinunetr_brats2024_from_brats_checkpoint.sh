#!/bin/bash
#SBATCH -J tr_swinunetr_brats2024_from_brats_checkpoint
...
#SBATCH --output=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/logs/tr_swinunetr_brats2024_from_brats_checkpoint%j.out
#SBATCH --error=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/errors/tr_swinunetr_brats2024_from_brats_checkpoint%j.err
...
/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/conda_envs/swinunetr/bin/python /home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/research-contributions/SwinUNETR/BRATS21/main.py \
    ...
    --feature_size 48 \
    --resume_ckpt \
    --logdir tr_from_brats2024_checkpoint \
    --pretrained_dir /home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/research-contributions/SwinUNETR/BRATS21/pretrained_models/fold1_f48_ep300_4gpu_dice0_9059 \
