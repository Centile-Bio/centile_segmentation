#!/bin/bash
#SBATCH -J pretrain_swinunetr_ukb_from_swin_vit_backbone
...
#SBATCH --output=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/logs/pretrain_swinunetr_ukb_from_swin_vit_backbone%j.out
#SBATCH --error=/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/cluster_results/errors/pretrain_swinunetr_ukb_from_swin_vit_backbone%j.err
...
/home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/conda_envs/swinunetr_env_py39/bin/torchrun \
    ...
    --logdir pretrain_swinunetr_ukb_from_swin_vit_backbone_lr_4e-7 \
    --batch_size=2 \
    --num_steps=100000 \
    --lrdecay \
    --eval_num=500 \
    --resume /home/fp427/rds/rds-cam-segm-7tts6phZ4tw/mission/research-contributions/SwinUNETR/Pretrain/pretrained_models/model_swinvit.pt \
    --lr=4e-7 \
    --noamp \
    --decay=0.1
